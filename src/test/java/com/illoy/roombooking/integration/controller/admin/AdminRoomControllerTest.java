...
public class AdminRoomControllerTest extends IntegrationTestBase {
    ...
    void findAll_shouldReturnRoomResponse() throws Exception {
        ...
        List<RoomResponse> rooms = objectMapper.readValue(result.getResponse().getContentAsString(), new TypeReference<>(){});
    ...
    void create_shouldReturnRoomResponseSuccess() throws Exception {
        ...
        RoomCreateEditRequest request = RoomCreateEditRequest.builder().name("New Room G").capacity(15).build();
    ...
    void update_shouldReturnRoomResponseSuccess() throws Exception {
        ...
        RoomCreateEditRequest request = RoomCreateEditRequest.builder().name("Meeting Room B-1").capacity(15).build();
    ...
    void update_shouldReturnRoomAlreadyExistsException() throws Exception {
        ...
        RoomCreateEditRequest request = RoomCreateEditRequest.builder().name("Small Room C").capacity(5).build();
    ...
    void updateStatus_shouldReturnRoomHasActiveBookingsException() throws Exception {
        ...
        Booking booking6 = Booking.builder().room(ROOM).user(USER)
