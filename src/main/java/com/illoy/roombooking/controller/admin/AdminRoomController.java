...
public class AdminRoomController {
    ...
    public ResponseEntity<RoomResponse> createRoom(
            @RequestBody @Validated(CreateAction.class) RoomCreateEditRequest request) {
    ...
    public ResponseEntity<Void> updateStatus(@PathVariable("roomId") Long id, @RequestParam boolean newStatus) {
